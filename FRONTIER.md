...
| Speed | `7525dc2` | `41f5719eb0630cc8dd78067806dfe4775b30d9e3b9b59e0701775d40c91e71af` | 8-bit v3 / high-bit v2+block encode; legacy decode | [EXP-0101](experiments/EXP-0101-tile-pair-speed-promotion.md) | Preserved |
...
emit four exact codes per writer update. On the one-thread lossy 10-bit path,
adjacent same-mode Rice tiles alternate their independent causal chains while
retaining separate reconstruction and writer states. The speed tier trades
...
|---|---:|---:|---:|---:|---:|
| Fastvid speed | q90 | 4.809339x | 93.787 | 68.387 | 52.001930 |
| Fastvid practical | q90 | 5.307903x | 16.797 | 60.331 | 52.002293 |
| Fastvid maximum | q90 | 5.307903x | 16.922 | 60.227 | 52.002293 |
...
0.266 dB higher Y-PSNR, encodes 15.53% faster, and decodes 7.75% faster. At
four threads Fastvid encodes 0.69% faster and decodes 18.87% faster.

At the high-fidelity boundary, Fastvid speed q100 is exact at 2.743688x,
63.843 MP/s encode, and 257.969880 Mb/s. OpenAPV `fastest` QP0 is not exact
(`max_error=2`) at 1.965097x, 63.200 MP/s, and 360.180000 Mb/s. Fastvid is
1.02% faster to encode and uses 28.38% less bitrate at this distinct,
...
[EXP-0101](experiments/EXP-0101-tile-pair-speed-promotion.md).
