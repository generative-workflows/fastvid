...
fn print_header() {
    println!(
        "sample\tframe\tbit_depth\tquality\tgop\ttile\tplane\twidth\theight\tsamples\tcurrent_mode\toracle_mode\tcurrent_entropy\toracle_entropy\tcurrent_bytes\toracle_bytes\tcurrent_sse\toracle_sse\tcurrent_max_error\toracle_max_error\tpaeth_bytes\tpaeth_sse\taverage_bytes\taverage_sse\tclamp_bytes\tclamp_sse\thalf_bytes\thalf_sse\ttemporal_bytes\ttemporal_sse\tband16_count\tband16_max_samples\tband16_payload_bytes\tband16_control_bytes\tband16_complete_bytes\tband16_sse\tband16_max_error\tband16_parallel_payload_bytes\tband16_parallel_control_bytes\tband16_parallel_complete_bytes\tband16_max_entropy_span\tband32_count\tband32_max_samples\tband32_payload_bytes\tband32_control_bytes\tband32_complete_bytes\tband32_sse\tband32_max_error\tband32_parallel_payload_bytes\tband32_parallel_control_bytes\tband32_parallel_complete_bytes\tband32_max_entropy_span\tband64_count\tband64_max_samples\tband64_payload_bytes\tband64_control_bytes\tband64_complete_bytes\tband64_sse\tband64_max_error\tband64_parallel_payload_bytes\tband64_parallel_control_bytes\tband64_parallel_complete_bytes\tband64_max_entropy_span"
    );
}
...
fn print_models(
    ...
    for (tile, model) in models.iter().enumerate() {
        ...
        println!(
            ...
            model.band16_clamp.parallel_payload_bytes,
            model.band16_clamp.parallel_control_bytes,
            model.band16_clamp.parallel_complete_bytes,
            model.band16_clamp.max_entropy_span,
            ...
            model.band32_clamp.parallel_payload_bytes,
            model.band32_clamp.parallel_control_bytes,
            model.band32_clamp.parallel_complete_bytes,
            model.band32_clamp.max_entropy_span,
            ...
            model.band64_clamp.parallel_payload_bytes,
            model.band64_clamp.parallel_control_bytes,
            model.band64_clamp.parallel_complete_bytes,
            model.band64_clamp.max_entropy_span,
        );
    }
}
